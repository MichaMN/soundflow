			...
			<div className="container">
				<div className="header">
					...
					<div className="header__btns">
						...
						<div
							className="header__theme-menu-btn"
							onClick={toggleThemeMenu}
						></div>
						<div className="header__theme-menu">
							<div
								className="header__theme-btn blueberry active"
								theme="blueberry"
								onClick={handleThemeColor}
							></div>
							<div
								className="header__theme-btn avocado"
								theme="avocado"
								onClick={handleThemeColor}
							></div>
							<div
								className="header__theme-btn cherry"
								theme="cherry"
								onClick={handleThemeColor}
							></div>
							<div
								className="header__theme-btn peach"
								theme="peach"
								onClick={handleThemeColor}
							></div>
							<div
								className="header__theme-btn eggplant"
								theme="eggplant"
								onClick={handleThemeColor}
							></div>
						</div>
